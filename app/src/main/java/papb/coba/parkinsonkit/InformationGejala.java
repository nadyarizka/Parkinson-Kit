 ...
 */
public class InformationGejala extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_information_gejala);
        ...
        WebView view = (WebView) this.findViewById(R.id.gejalaWebView);  //sinkronisasi object berdasarkan id
        ...
        String data = getString(R.string.gejala_konten);
