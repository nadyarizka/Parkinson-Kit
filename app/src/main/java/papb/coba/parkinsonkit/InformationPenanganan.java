...
/**
 * Created by Amalina Kurniasari on 07/12/2015.
 */
public class InformationPenanganan extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_information_penanganan);
        ...
        WebView view = (WebView) this.findViewById(R.id.penangananWebView);  //sinkronisasi object berdasarkan id
        ...
        String data = getString(R.string.penanganan_konten);
