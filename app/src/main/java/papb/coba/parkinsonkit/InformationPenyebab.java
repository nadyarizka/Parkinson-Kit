...
public class InformationPenyebab extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_information_penyebab);
        ...
        WebView view = (WebView) this.findViewById(R.id.penyebabWebView);  //sinkronisasi object berdasarkan id
        ...
        String data = getString(R.string.penyebab_konten);
